	...
	<view>
		...
		<view class="commentlist">
			...
			<view class="uni-center">
				...
				<text  v-else style="color: #999; padding: 20upx;">已显示全部晒图</text>
			</view>
			</block>
			<block v-else>
				<view style="text-align: center; color: #999; padding: 20upx;">还没有人晒图哦~</view>
			</block>
		</view>
		...
		<view class="foot-fiexd" v-if="IsShowReplyBox">
			...
			<view :class="['foot-reply',IsShowReplyBox?'active':'']">
				<input class="ipt" type="text" v-model="Comment" :placeholder="placeholder"/>
				<view class="btn-r">
...
<script>
	...
	export default {
		...
		methods:{
			...
			gotoAll(){
				uni.navigateTo({
					url: '/pages/Article/Actreplylist/Actreplylist?id='+this.FkId
				})
			},
			gotoUserhome(mid){
				uni.navigateTo({
...
<style>
	...
	.foot-reply .sendBtn{ background: #ee9b11; color: #fff; border-radius: 6px; height: 60upx; line-height: 60upx; padding: 0 20upx; margin: 20upx 20upx 20upx 0;}
